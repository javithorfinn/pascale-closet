            ...
            <div className="p-6">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                {(order.buyer_first_name || order.buyer_name) && (
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-[#F5F0EB] border border-[#E0D6CC] flex items-center justify-center">
                      <User size={18} className="text-[#2C2420]" />
                    </div>
                    <div>
                      <p className="text-[#7A6B5A] font-sans-elegant text-xs uppercase tracking-wide">
                        Nombre
                ...
                {order.buyer_email && (
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-[#F5F0EB] border border-[#E0D6CC] flex items-center justify-center">
                      <Mail size={18} className="text-[#2C2420]" />
                    </div>
                    <div>
                      <p className="text-[#7A6B5A] font-sans-elegant text-xs uppercase tracking-wide">
                        Email
                ...
                {order.buyer_phone && (
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-[#F5F0EB] border border-[#E0D6CC] flex items-center justify-center">
                      <Phone size={18} className="text-[#2C2420]" />
                    </div>
                    <div>
                      <p className="text-[#7A6B5A] font-sans-elegant text-xs uppercase tracking-wide">
                        Teléfono
                ...
                {order.buyer_address && (
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-[#F5F0EB] border border-[#E0D6CC] flex items-center justify-center">
                      <MapPin size={18} className="text-[#2C2420]" />
                    </div>
                    <div>
                      <p className="text-[#7A6B5A] font-sans-elegant text-xs uppercase tracking-wide">
                        Dirección
                ...
                {order.buyer_city && (
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-[#F5F0EB] border border-[#E0D6CC] flex items-center justify-center">
                      <Truck size={18} className="text-[#2C2420]" />
                    </div>
                    <div>
                      <p className="text-[#7A6B5A] font-sans-elegant text-xs uppercase tracking-wide">
                        Ciudad
